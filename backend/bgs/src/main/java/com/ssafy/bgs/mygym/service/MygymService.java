...
public class MygymService {
    ...
    public MygymService(UserRepository userRepository, MygymColorRepository mygymColorRepository, PlaceRepository placeRepository, GuestbookRepository guestbookRepository, ImageService imageService) {
