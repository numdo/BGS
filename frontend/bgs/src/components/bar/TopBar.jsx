  ...
  return (
    <div className="w-full border-b z-10">
      <div className="flex justify-between items-center px-4 py-3">
        ...
        <button className="text-gray-600 hover:text-blue-500" onClick={toggleDropdown}>
      ...
      {isOpen && (
        <div className="absolute right-0 w-28 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
          <div className="" role="menu">
            <div onClick={() => handleLogout(navigate)} // ✅ handleLogout 함수 실행
              className="hover:bg-gray-100 m-1 p-1">
              <img src={SignoutIcon} alt="signout" className="inline-block align-middle mr-2" />
              <p className="inline-block align-middle">로그아웃</p>
            </div>
            <div onClick={() => { }} // ✅ handleLogout 함수 실행
              className="hover:bg-gray-100 mx-1 mb-1 p-1">
              <img src={SignoutIcon} alt="signout" className="inline-block align-middle mr-2" />
              <p className="inline-block align-middle">옵션</p>
            </div>
