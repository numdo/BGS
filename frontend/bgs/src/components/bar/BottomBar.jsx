      ...
      <div className="fixed bottom-0 left-0 w-[100vw] bg-white border-t border-gray-200 shadow-lg">
        <div className="flex justify-evenly items-center py-2">
          ...
          >
            ...
            <span
              className={`text-sm font-bold ${
                location.pathname.startsWith("/workout") ? "text-primary" : ""
              }`}
            >
              운동일지
            </span>
          ...
          >
            ...
            <span
              className={`text-sm font-bold ${
                location.pathname.startsWith("/mygym") ? "text-primary" : ""
              }`}
            >
              마이짐
            </span>
          ...
          >
            ...
            <span
              className={`text-sm font-bold ${
                location.pathname.startsWith("/feed") ? "text-primary" : ""
              }`}
            >
              피드
            </span>
          ...
          >
            ...
            <span
              className={`text-sm font-bold ${
                location.pathname.startsWith("/myinfo") ? "text-primary" : ""
              }`}
            >
              내정보
            </span>
